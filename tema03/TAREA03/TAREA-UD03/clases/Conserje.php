 ...
 * Conserje: Clase que hace referencia al personal conserje.
 */

require_once "Personal.php";

class Conserje extends Personal
{
    ...
    public function __construct($nombre, $primerApellido, $segundoApellido, $fechaNacimiento, $direccion, $telefono, $sexo, $aniosServicio)
    {
        ...
        Conserje::$nObjetosCreados++;
    }

    /**
     * Genera con valores al azar una clase de tipo Conserje
     * @return Conserje
     */
    public static function generarAlAzar(): Conserje
    {
        ...
        return new Conserje($nombreEscogido, $primerApellidoEscogido, $segundoApellidoEscogido, $fechaEscogida, $direccionEscogida, $telefonoEscogido, $sexoEscogido, $aniosServicioEscogido);
    }
    ...
    {
        return Conserje::$nObjetosCreados;
    }
    ...
    public function trabajar()
    {
        if ($this->getSexo() == "Hombre") {
            return "Soy un conserje" . parent::trabajar();
        } else {
            return "Soy una conserje" . parent::trabajar();
        }
    }
    /**
    ...
    {
        return "Conserje: " . parent::__tostring();
    }
