 ...
 * AlumnadoBach Clase que hace referencia al alumnado de bachiller.
 */
require_once "Alumno.php";
class AlumnadoBach extends Alumno
{
    ...
    public function __construct($nombre, $primerApellido, $segundoApellido, $fechaNacimiento, $direccion, $telefono, $sexo, $curso, $grupo)
    {
        ...
        AlumnadoBach::$nObjetosCreados++;
    }
    /**
     * Genera con valores al azar una clase de tipo AlumnadoBach
     * @return AlumnadoBach
     */
    public static function generarAlAzar()
    {
        ...
        return new AlumnadoBach($nombreEscogido, $primerApellidoEscogido, $segundoApellidoEscogido, $fechaEscogida, $direccionEscogida, $telefonoEscogido, $sexoEscogido, $cursoEscogido, $grupoEscogido);
    }
    ...
    {
        return AlumnadoBach::$nObjetosCreados;
    }

    /**
     * Representa la clase AlumnadoBach como cadena de texto
     * @return string
     */
    public function __tostring()
    {
        return "Alumnado Bachiller: " . parent::__tostring();
    }
    ...
    public function trabajar()
    {
        if ($this->getSexo() == "Hombre") {
            return "Soy un alumno de bachiller" . parent::trabajar();
        } else {
            return "Soy una alumna de bachiller" . parent::trabajar();
        }
    }
