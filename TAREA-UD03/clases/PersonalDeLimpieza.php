 ...
 * Personal de limpieza: Clase que hace referencia al personal de limpieza.
 */

require_once "Personal.php";
class PersonalDeLimpieza extends Personal
{
    ...
    public function __construct($nombre, $primerApellido, $segundoApellido, $fechaNacimiento, $direccion, $telefono, $sexo, $aniosServicio)
    {
        ...
        PersonalDeLimpieza::$nObjetosCreados++;
    }
    /**
     * Genera con valores al azar una clase de tipo Personal de limpieza
    ...
    public static function generarAlAzar()
    {
        ...
        return new PersonalDeLimpieza($nombreEscogido, $primerApellidoEscogido, $segundoApellidoEscogido, $fechaEscogida, $direccionEscogida, $telefonoEscogido, $sexoEscogido, $aniosServicioEscogido);
    }
    /**
    ...
    {
        return PersonalDeLimpieza::$nObjetosCreados;
    }
    /**
     * Representa la clase Personal de limpieza como cadena de texto
     * @return string
     */
    public function __tostring()
    {
        return "Personal de limpieza: " . parent::__tostring();
    }
    /**
    ...
    public function trabajar()
    {
        if ($this->getSexo() == "Hombre") {
            return "Soy un limpiador" . parent::trabajar();
        } else {
            return "Soy una limpiadora" . parent::trabajar();
        }
    }
